...
(function(n) {
    function v(b, f) {
        ...
        for (c = 0; c < h.length; c++)
            ...
            q = q.toLowerCase(),
            window.requestAnimationFrame || (window.requestAnimationFrame = window[q + "RequestAnimationFrame"],
    ...
    v.prototype = {
        ...
        _n2: function(b, f) {
            ...
            if (!b)
                ...
                r = t > m ? 0 : t,
                k = 0; k < q; k++)
                    t > m && k > t - 1 || !(k < r || k > m) || (h = d.slides[k]) && h.holder && (h.holder.detach(),
                    h.isAdded = !1)
        },
                    ...
                    if (0 === w || 1 >= t)
                        ...
                        if (f) {
                            ...
                            if (h > e._n3)
                                ...
                                l = -e._i3;
                                p = e._y3 - e._z3 + e._i3;
                                0 < g && m > l ? (l += e._z3 / (15 / (m / d * .003)),
                                d = d * l / m,
                                m = l) : 0 > g && m > p && (p += e._z3 / (15 / (m / d * .003)),
                                d = d * p / m,
                                m = p);
                            ...
                            ,
                            p + q < m ? 0 > w ? a(!1, d) : (l = l(m - p),
                            e._m2(e.currSlideId - l, c(Math.abs(e._p - (-e._u - e._d1 + l) * e._w) / d), !1, !0, !0)) : p - q > m ? 0 < w ? a(!1, d) : (l = l(p - m),
    ...
    f.extend(f.rsProto, {
        _h6: function() {
            ...
            a.ev.on("rsBeforeParseNode", function(a, b, c) {
                ...
                c.thumbnail.length ? c.thumbnail = f(document.createElement("div")).append(c.thumbnail).html() : (c.thumbnail = b.attr("data-rsTmb"),
            ...
            a.ev.on("rsOnRemoveSlide", function(e, b) {
                var c = a._l5.eq(b);
                c && (a._e && a._s3.css(a._g + "transition-duration", "0ms"),
                c.remove(),
                a._l5 = a._s3.children(),
                a.updateThumbsSize(!0))
            }))
        ...
        _k6: function() {
            ...
            a._q6 && (e += "Arrow",
            b.arrowLeft ? a._r6 = b.arrowLeft : (a._r6 = f('<div class="' + e + " " + e + 'Left"><div class="' + e + 'Icn"></div></div>'),
            c.append(a._r6)),
            b.arrowRight ? a._s6 = b.arrowRight : (a._s6 = f('<div class="' + e + " " + e + 'Right"><div class="' + e + 'Icn"></div></div>'),
            c.append(a._s6)),
        ...
        updateThumbsSize: function(a, e) {
            ...
            b._y3 < b._z3 ? (b.st.thumbs.autoCenter ? b._q3((b._z3 - b._y3) / 2) : b._q3(b._n3),
        ...
        _a4: function(a, e, b, c, g) {
            ...
            if (d._l6) {
                ...
                h[d._g + "transition-timing-function"] = b ? f.rsCSS3Easing[d.st.easeOut] : f.rsCSS3Easing[d.st.easeInOut],
                d._s3.css(h),
            ...
            if (a.st.deeplinking.enabled) {
                var g = a.st.deeplinking.change
                  ...
                  , k = function() {
                    ...
                    return a && 0 < a.indexOf(e) && (a = parseInt(a.substring(c.length), 10),
                    0 <= a) ? a - 1 : -1
                }
                  , p = k();
    ...
    g = function() {
        function g() {
            var f = d()
              , e = q(l);
            f !== l ? (m(l = f, e),
            b(a).trigger("hashchange")) : e !== l && (location.href = location.href.replace(/#.*/, "") + e);
        ...
        a.attachEvent && !a.addEventListener && !k && function() {
            var a, c;
            e.start = function() {
                a || (c = (c = b.fn.hashchange.src) && c + d(),
                a = b('<iframe tabindex="-1" title="empty"/>').hide().one("load", function() {
                    c || m(d());
                    g()
